...
func TestUpstreamResponseRetryPreservesExecutionBoundaries(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "transport after headers", status: 200, evidence: execution.ErrorEvidence{Kind: execution.ErrorKindTransport}, retry: RetryNextCandidate, effect: EffectNone},
		{name: "timeout after headers", status: 200, evidence: execution.ErrorEvidence{Kind: execution.ErrorKindTimeout}, retry: RetryNextCandidate, effect: EffectNone},
		{name: "protocol failure", status: 200, evidence: execution.ErrorEvidence{Kind: execution.ErrorKindProvider, Code: "upstream_protocol_error"}, retry: RetryNextCandidate, effect: EffectNone},
		{name: "incomplete response", status: 200, evidence: execution.ErrorEvidence{Kind: execution.ErrorKindProvider, Code: "upstream_response_incomplete"}, retry: RetryNextCandidate, effect: EffectNone},
		{name: "committed transport after headers", status: 200, evidence: execution.ErrorEvidence{Kind: execution.ErrorKindTransport}, committed: true, retry: RetryNone, effect: EffectNone},
		{name: "committed timeout after headers", status: 200, evidence: execution.ErrorEvidence{Kind: execution.ErrorKindTimeout}, committed: true, retry: RetryNone, effect: EffectNone},
		{name: "committed protocol failure", status: 200, evidence: execution.ErrorEvidence{Kind: execution.ErrorKindProvider, Code: "upstream_protocol_error"}, committed: true, retry: RetryNone, effect: EffectNone},
		{name: "committed incomplete response", status: 200, evidence: execution.ErrorEvidence{Kind: execution.ErrorKindProvider, Code: "upstream_response_incomplete"}, committed: true, retry: RetryNone, effect: EffectNone},
